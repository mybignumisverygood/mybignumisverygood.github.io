// format-EN.js by cloudytheconqueror
...
// Basically does the opposite of what standardize in EN does
...
// Search for the value at the requested height of an EN array,
...
function format(num, precision=2, small=false) {
    ...
    if (num.lt("0.0001")) { return format(num.rec(), precision) + "⁻¹" }
        ...
        // EN.js considers J1 to be equal to 1e10 rather than 10,
        // hence num.lt("J^999999 10") rather than num.lt("J^1000000 1").
        let pol = polarize(array, true)
        let layerLess = new EN(array)
        let layer = num.layer
        let topJ
