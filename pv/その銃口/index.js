...
// document.addEventListener("keydown", function(e) {if (event.code === 'Space') {document.getElementById("sec").innerHTML = bgm.currentTime + "," + (bgm.currentTime-0.783)/beat*1000;}})
...
async function main(){
	...
	await wait(offset + beat * 2 - bgm.currentTime * 1000);
	centerPos(sono);
	...
	var interval1 = [1 - (bgm.currentTime - (offset + beat * 33) / 1000), 4, 4, 7, 1, 8, 4, 2];
	...
	var interval2 = [2 - (bgm.currentTime - (offset + beat * 64) / 1000), 4, 4, 6.5, 1.5, 8, 4, 2];
	...
	var interval3 = [2 - (bgm.currentTime - (offset + beat * 96) / 1000), 4, 4, 7.5, 0.5, 8, 7.5];
	...
	var interval4 = [0, 8, 6.75, 0.75, 0.5, 6.5, 1.5, 0.75, 2.5, 4.5];
	...
	var interval5 = [1.25 - (bgm.currentTime - (offset + beat * 193.75) / 1000), 8, 6, 2, 7, 7];
	...
	var interval6 = [1.5, 8, 8, 8, 8, 8, 8, 8, 7];
	...
	var interval7 = [0.5 - (bgm.currentTime - (offset + beat * 290.5) / 1000), 4, 4, 4, 3.5, 0.5, 8, 7.5];
